    ...
    <div className='dropdownText'>
      <div className='buttons'>
        <button
          onClick={() =>
            handleButtonClick(
              'A Escola Caliandra tem como objetivo preparar a criança para ser um indivíduo autônomo, responsável, respeitoso e capaz de contribuir positivamente para a sociedade.'
            )
          }
        >
          Objetivo
