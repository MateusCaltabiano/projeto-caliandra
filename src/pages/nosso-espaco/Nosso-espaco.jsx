      ...
      <div className='NossoEspaco_bg'>
        ...
        <div className='NossoEspaco_main'>
          <p className='NossoEspaco_p'>
            ...
            pequena Caliandra floresceu! Nos mudamos para um espaço maior, mas
            que ainda traz o aconchego que gostamos de ter para receber nossos
            alunos e a abundância da natureza para enriquecer os processos de
            aprendizado.
          </p>
          ...
          <p className='NossoEspaco_p'>
            ...
            oferecer o que há de mais inovador e belo para nossas crianças.
            Venha conhecer esse espaço maravilhoso e ver de perto esse trabalho
            tão diferenciado que estamos construindo aqui, na Avenida do Sol do
            Jardim Botânico.
          </p>
        </div>
      </div>
